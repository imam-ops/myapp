...
class UserKtphilang extends StatefulWidget {
  @override
  _UserKtphilangState createState() => _UserKtphilangState();
}

class _UserKtphilangState extends State<UserKtphilang> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'Surat Kehilangan Kepolisian', isChecked: false),
    RequirementItem(text: 'Fotocopy KTP', isChecked: false),
  ];
