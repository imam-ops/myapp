...
class UserKiarusak extends StatefulWidget {
  @override
  _UserKiarusakState createState() => _UserKiarusakState();
}

class _UserKiarusakState extends State<UserKiarusak> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KIA Rusak', isChecked: false),
    RequirementItem(text: 'Fotocopy KK', isChecked: false),
  ];
