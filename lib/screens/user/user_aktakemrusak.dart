...
class UserAktakemrusak extends StatefulWidget {
  @override
  _UserAktakemrusakState createState() => _UserAktakemrusakState();
}

class _UserAktakemrusakState extends State<UserAktakemrusak> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'Akta Kematian Rusak', isChecked: false),
    RequirementItem(text: 'Fotocopy Akta Kematian', isChecked: false),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Akta Kematian Rusak'),
