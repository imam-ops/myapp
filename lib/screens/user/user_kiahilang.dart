...
class UserKiahilang extends StatefulWidget {
  @override
  _UserKiahilangState createState() => _UserKiahilangState();
}

class _UserKiahilangState extends State<UserKiahilang> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'Surat Kehilangan Kepolisian', isChecked: false),
    RequirementItem(text: 'Fotocopy KIA', isChecked: false),
  ];
