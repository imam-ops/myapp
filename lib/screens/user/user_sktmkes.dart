...
class UserSktmkes extends StatefulWidget {
  @override
  _UserSktmkesState createState() => _UserSktmkesState();
}

class _UserSktmkesState extends State<UserSktmkes> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KK Terbaru', isChecked: false),
    RequirementItem(text: 'KTP', isChecked: false),
    RequirementItem(text: 'ID DTKS', isChecked: false),
  ];
