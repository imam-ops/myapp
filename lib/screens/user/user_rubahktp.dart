...
class UserRubahktp extends StatefulWidget {
  @override
  _UserRubahktpState createState() => _UserRubahktpState();
}

class _UserRubahktpState extends State<UserRubahktp> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KK Terbaru', isChecked: false),
    RequirementItem(text: 'KTP Lama', isChecked: false),
  ];
