...
class UserAktakemhilang extends StatefulWidget {
  @override
  _UserAktakemhilangState createState() => _UserAktakemhilangState();
}

class _UserAktakemhilangState extends State<UserAktakemhilang> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Akta Kematian Hilang'),
