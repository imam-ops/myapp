...
class UserKkrusak extends StatefulWidget {
  @override
  _UserKkrusakState createState() => _UserKkrusakState();
}

class _UserKkrusakState extends State<UserKkrusak> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KK Rusak', isChecked: false),
    RequirementItem(text: 'KTP Asli Anggota Keluarga', isChecked: false),
  ];
