...
class UserAktakelrusak extends StatefulWidget {
  @override
  _UserAktakelrusakState createState() => _UserAktakelrusakState();
}

class _UserAktakelrusakState extends State<UserAktakelrusak> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'Akta Kelahiran Rusak', isChecked: false),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Akta Kelahiran Rusak'),
