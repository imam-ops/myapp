...
class UserRubahaktakem extends StatefulWidget {
  @override
  _UserRubahaktakemState createState() => _UserRubahaktakemState();
}

class _UserRubahaktakemState extends State<UserRubahaktakem> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'Akta Kematian', isChecked: false),
    RequirementItem(text: 'Data Dukung : Penetapan Pengadilan / Lainnya', isChecked: false),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Perubahan Data Akta Kematian'),
