...
class UserKetskck extends StatefulWidget {
  @override
  _UserKetskckState createState() => _UserKetskckState();
}

class _UserKetskckState extends State<UserKetskck> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KK Terbaru', isChecked: false),
    RequirementItem(text: 'KTP', isChecked: false),
    RequirementItem(text: 'Pas Photo', isChecked: false),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Surat Keterangan SKCK'),
