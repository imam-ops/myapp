...
class UserRubahaktakel extends StatefulWidget {
  @override
  _UserRubahaktakelState createState() => _UserRubahaktakelState();
}

class _UserRubahaktakelState extends State<UserRubahaktakel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Perubahan Data Akta Kelahiran'),
