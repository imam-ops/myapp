...
class UserKtprusak extends StatefulWidget {
  @override
  _UserKtprusakState createState() => _UserKtprusakState();
}

class _UserKtprusakState extends State<UserKtprusak> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KTP Rusak', isChecked: false),
