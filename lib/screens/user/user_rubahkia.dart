...
class UserRubahkia extends StatefulWidget {
  @override
  _UserRubahkiaState createState() => _UserRubahkiaState();
}

class _UserRubahkiaState extends State<UserRubahkia> {
  List<RequirementItem> requirements = [
    RequirementItem(text: 'KK Terbaru', isChecked: false),
    RequirementItem(text: 'KIA Lama', isChecked: false),
  ];
